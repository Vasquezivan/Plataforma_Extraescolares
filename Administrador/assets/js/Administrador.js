...
// --- ESTILOS PARA LA BARRA DE ACTIVIDADES DESPLAZABLE ---
const estiloBarraActividades = document.createElement('style');
estiloBarraActividades.textContent = `
  .barra-actividades {
    display: flex;
    flex-wrap: nowrap;
    overflow-x: auto;
  ...
  .barra-actividades::-webkit-scrollbar {
    height: 8px;
  }
  .barra-actividades::-webkit-scrollbar-track {
    background: #f1f1f1;
    border-radius: 10px;
  }
  .barra-actividades::-webkit-scrollbar-thumb {
    background: #888;
    border-radius: 10px;
  }
  .barra-actividades::-webkit-scrollbar-thumb:hover {
    background: #555;
  }
  .barra-actividades .boton-actividad {
    flex: 0 0 auto;
    margin: 0;
    min-width: 120px;
    max-width: 220px;
...
`;
document.head.appendChild(estiloBarraActividades);
