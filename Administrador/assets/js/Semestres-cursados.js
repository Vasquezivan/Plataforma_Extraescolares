...
document.addEventListener('DOMContentLoaded', async function() {
      ...
      btnEliminar.addEventListener('click', function() {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            try {
              const semestreId = id || (semestre.id || semestre.id_semestre);
  ...
  btnCrearSemestre.addEventListener('click', function() {
    ...
    document.getElementById('tituloModal').textContent = 'Crear Nuevo Semestre';
    document.getElementById('semestreId').value = '';
    semestreEnEdicion = null;
    formSemestre.reset(); // Limpiar formulario
  });
